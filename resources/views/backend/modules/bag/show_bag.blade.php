        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header row justify-content-between">
                <div class="col-4"><h3 class="card-title">All Begs</h3></div>
              <div class="col-6">
                
                 <form class="form-inline" action="{{URL::to('upload_bag_barcode')}}" method="POST" enctype="multipart/form-data">
                 {{csrf_field()}} 
                 <label class="m-1" style=" color: #575977;">Add New Bag Code</label> 
